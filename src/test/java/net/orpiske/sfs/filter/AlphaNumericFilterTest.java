...
import net.orpiske.sfs.filter.simple.AlphaNumericFilter;
import org.junit.Assert;
import org.junit.Test;


public class AlphaNumericFilterTest {
	private static Filter filter = new AlphaNumericFilter();
	...
	public void testNumber() {
		...
		Assert.assertEquals("The string was not filtered correctly", NUMBER, ret);
	}
